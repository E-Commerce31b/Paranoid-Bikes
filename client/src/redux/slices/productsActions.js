...
export const getQueryById = createAsyncThunk('products/getProductById', async (id) => {
    try {
...
export const postQuery = createAsyncThunk('products/postProduct', async (newBike) => {
    try {
...
export const putQuery = createAsyncThunk('products/putProduct', async ({_id, ...query}) => {
    try {
...
export const deleteQuery = createAsyncThunk('products/deleteProduct', async (id) => {
    try {
